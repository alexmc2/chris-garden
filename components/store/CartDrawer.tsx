                    ...
                    <div className="relative h-24 w-24 overflow-hidden rounded-xl bg-muted">
                      {item.image?.url ? (
                        <Image
                          ...
                          sizes="120px"
                          placeholder={
                            item.image.blurDataURL ? 'blur' : undefined
                          }
              ...
              <div className="flex flex-col gap-2">
                <Button
                  ...
                  className={cn(
                    ...
                    (!isHydrated || items.length === 0) && 'pointer-events-none opacity-60'
                  )}
                >
                  <Link href="/checkout" aria-disabled={!isHydrated || items.length === 0}>
                    Proceed to checkout
                  </Link>
                </Button>
                <Button
